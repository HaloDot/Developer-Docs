...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>The Architecture of this isolating MPoC Payment Software, below is a diagram showcasing the SDK boundary and the interaction between the SDK and integrating channels, and the 3rd party payment gateway.</p><p></p><p></p><p></p><p> </p> |
