...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p>The Architecture of this isolating MPoC Payment Software, below is the SDK Boundaries and the flows within. This shows the interaction between the SDK and the 3rd Party Payment Gateway. </p><p></p><p></p><p> </p> |
