...
| ------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| JWT                 | Application → SDK | The JWT is required by all SDK functions, and must be provided by the integrating application                                                                                                                                             | This is documented in the [key management](key-management.md) document                                                                                                              |
