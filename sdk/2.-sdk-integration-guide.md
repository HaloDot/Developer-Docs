...
* [SDK Mobile Integration Guide](2.-sdk-integration-guide.md#sdk-mobile-integration-guide)
  * [1. Remote Attestation of Application by Halo Server](2.-sdk-integration-guide.md#1-remote-attestation-of-application-by-halo-server)
  * [2. Requirements on the Mobile Back-End](2.-sdk-integration-guide.md#2-requirements-on-the-mobile-back-end)
  * [3. SDK Binary](2.-sdk-integration-guide.md#3-sdk-binary)
  * [4. Application Manifest](2.-sdk-integration-guide.md#4-application-manifest)
  * [5. Life-Cycle Methods](2.-sdk-integration-guide.md#5-life-cycle-methods)
  * [6. Initialization of the SDK](2.-sdk-integration-guide.md#6-initialization-of-the-sdk)
  * [7. Transaction Flow](2.-sdk-integration-guide.md#7-transaction-flow)
  * [8. SDK Async Behaviour after startTransaction Returns](2.-sdk-integration-guide.md#8-sdk-async-behaviour-after-starttransaction-returns)
  * [9. Conclusion](2.-sdk-integration-guide.md#9-conclusion)
...
| field                      | description                                                                  |
| -------------------------- | ---------------------------------------------------------------------------- |
| apkPackageName             | fully qualifi ed APK name, e.g. za.co.synthesis.halo.halo\_mpos\_new         |
...
| halo\_aud\_fingerprints |    String   | a CSV list of expected SHA-256 fingerprints for the Kernel Server TLS endpoint. This list may contain multiple values to support certificate rotation.                                                                                                                                                                                                    |
...
The `merchantTransactionReference` is a unique-per-merchant transaction reference generated and supplied by the mobile application. Halo will generate and maintain its own internal ID for the transaction (`haloTransactionReference`), but from the perspective of the mobile application `merchantTransactionReference` together with the value of the `Payment Processor Merchant-User ID` specified in the JWT `sub` field can be used to uniquely identify a merchant transaction.
...
Not what you were looking for? If you are looking for the Intent Integration guide, it is over [here](../intents/1.-getting-started/)
